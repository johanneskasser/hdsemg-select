...
from PyQt5.QtWidgets import QMessageBox, QPushButton, QApplication, QStyle
...
def exception_hook(exc_type, exc_value, exc_traceback):
    ...
    dlg.setText(
        "An unexpected error occurred.<br>Please report this issue to the developers <a href='https://github.com/johanneskasser/hdsemg-select/issues'>here</a> and append the detailed log report below.")
