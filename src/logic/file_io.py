...
def save_selection_to_json(file_path, file_name, grid_info, channel_status):
    """
    ...
    for grid_key, info in grid_info.items():
        ...
        channels_for_grid = [
            {"channel": ch_idx + 1, "selected": channel_status[ch_idx]}
...
def save_selection_to_mat(save_file_path, data, time, description, sampling_frequency, channel_status):
    """
